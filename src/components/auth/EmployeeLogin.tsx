  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Employee Login</h1>
        ...
        <p className="mt-4 text-sm text-gray-600">If you are a manager or admin, return to the Access menu.</p>
      </div>
    </div>
  );
}
