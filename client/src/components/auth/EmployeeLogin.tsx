  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-primary px-4">
      <div className="max-w-md w-full card-elevated p-8 border border-primary-200">
        <h1 className="text-2xl font-bold text-neutral-900 mb-6">Employee Login</h1>
        ...
        <p className="mt-4 text-sm text-neutral-600">If you are a manager or admin, return to the Access menu.</p>
      </div>
    </div>
  );
}
